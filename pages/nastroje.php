                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="card card-text">
                                <img src="../img/vs-code-logo.svg" class="card-img-top" alt="Visual Studio Code">
                                <div class="card-body">
                        ...
                        <div class="carousel-item">
                            <div class="card card-text">
                                <img src="../img/sublime-text-logo.svg" class="card-img-top" alt="Sublime Text">
                                <div class="card-body">
                        ...
                        <div class="carousel-item">
                            <div class="card card-text">
                                <img src="../img/brackets-logo.svg" class="card-img-top" alt="Brackets">
                                <div class="card-body">
            ...
            <div class="col-md-8">
                ...
                <div class="card card-text">
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <button class="btn btn-primary"
                                onclick="window.open('http://github.com/', '_blank')">Otvoriť</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="card card-text">
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <button class="btn btn-primary"
                                onclick="window.open('https://www.w3schools.com/', '_blank')">Otvoriť</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="card card-text">
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <button class="btn btn-primary"
                                onclick="window.open('https://codepen.io/', '_blank')">Otvoriť</button>
                        </div>
                    </div>
                </div>
            </div>
