...
<body>
    ...
    if ($isTeacher) {
        ...
        echo '<button type="button" class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#editCssModal" style="margin-bottom: 10px;"><i class="fa-regular fa-pen-to-square"></i> Upraviť príklad</button>';
        echo '</div>';
        echo '</div>';
        echo '</div>';
    }
    ...
    <?php include '../includes/admin-css-edit.php'; ?>
