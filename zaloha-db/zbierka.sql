...
--
-- Hostiteľ: db
-- Čas generovania: St 06.Mar 2024, 18:06
...
(5, '5 Správa CSS', '5.1 Svetlý a Tmavý režim', 'Pomocou tlačidla na stránke zmeňte tému stránky na tmavú. Viď. video.', '../priklady/js/5.1 Svetlý a tmavý režim/pr1.html', '../priklady/js/5.1 Svetlý a tmavý režim/pr1.css', '../priklady/js/5.1 Svetlý a tmavý režim/pr1.js', '', '', '', '', '../priklady/js/5.1 Svetlý a tmavý režim/pr1.mp4', '', '1'),
...
(17, '5 Správa CSS', '5.2 Zmena farby pozadia', 'Vytvorte webovú stránku, ktorá bude na vstup používateľa meniť farbu pozadia ako je to viditeľné na videu v zadaní.<br><br>\r\n<strong>Bonusová úloha:</strong><br>\r\n<br>\r\nMajte na stránke text a meňte jeho farbu aby bol vždy čitateľným ako na videu v zadaní.', '../priklady/js/5.2 Zmena farby pozadia/color-picker.html', '../priklady/js/5.2 Zmena farby pozadia/style.css', '../priklady/js/5.2 Zmena farby pozadia/color-picker.js', '', '', '', '', '../priklady/js/5.2 Zmena farby pozadia/video.mp4', '', '1'),
(18, '6 Vyskakovacie okná', '6.2 Poistka', 'Vytvorte vyskakovacie okno u obchodníka s autami. Toto okno by sa malo ukazovať používateľovi webstránky dookola v loope. Viď. video.', '../priklady/js/6.2 Poistka/poistka.html', '../priklady/js/6.2 Poistka/style.css', '../priklady/js/6.2 Poistka/script.js', '', '', '', '', '../priklady/js/6.2 Poistka/video.mp4', '', '1'),
...
(20, '8 Tabuľky', '8.2 Tabuľka z JSON súboru', 'Podľa priloženého súboru vytvorte webstránku, ktorá vytvorí z týchto údajov tabuľku ako je na videu v zadaní.', '../priklady/js/8.2 Tabuľka z JSON súboru/tabulka.html', '../priklady/js/8.2 Tabuľka z JSON súboru/style.css', '../priklady/js/8.2 Tabuľka z JSON súboru/script.js', '../priklady/js/8.2 Tabuľka z JSON súboru/súbor.json', '', '', '', '../priklady/js/8.2 Tabuľka z JSON súboru/video.mp4', '', '1'),
(21, '9 Vyhľadávanie', '9.2 Hľadanie Gifov', 'Pomocou <strong>GIPHY API</strong> (registrácia a API kľúč sú zadarmo) vytvorte webstránku na ktorej môže používateľ hľadať rôzne gify. Viď. video.', '../priklady/js/9.2 Hľadanie Gifov/gify.html', '../priklady/js/9.2 Hľadanie Gifov/style.css', '../priklady/js/9.2 Hľadanie Gifov/script.js', '', '', 'https://developers.giphy.com/docs/api#quick-start-guide', '', '../priklady/js/9.2 Hľadanie Gifov/video.mp4', '', '1');
