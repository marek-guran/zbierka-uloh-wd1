...
--
-- Hostiteľ: db
-- Čas generovania: Út 31.Okt 2023, 10:57
...
(13, '2 AJAX', '2.2 Čas a náhodný text', 'Pomocou priloženej knižnice vytvorte webstránku, na ktorej sa bude zobrazovať <strong>aktuálny čas, náhodná veta</strong> podľa vášho výberu <strong>(aspoň 5)</strong> a táto veta sa bude meniť každých <strong>10 sekúnd.</strong> Následne vytvorte <strong>odpočítavanie,</strong> ktoré bude ukazovať v <strong>reálnom čase,</strong> kedy sa bude meniť táto <strong>náhodná veta.</strong> Môžete sa inšpirovať videom.', '../priklady/js/2.2 Čas a náhodný text/cas-text.html', '../priklady/js/2.2 Čas a náhodný text/cas-text.css', '../priklady/js/2.2 Čas a náhodný text/script.js', '', '../priklady/js/2.2 Čas a náhodný text/jquery-3.7.1.js', 'https://api.jquery.com/', '', '../priklady/js/2.2 Čas a náhodný text/Video.mp4', '', '1');
