...
--
-- Hostiteľ: db
-- Čas generovania: Sun 29.Okt 2023, 13:27
...
(2, '2 Responzivita', '2.1 Responzivita', 'Vytvorte stránku na ktorej budete mať 2 karty, každá karta bude mať aspoň jeden obrázok a pod obrázkom text. Ako ďalšie vytvoríte 3 články a každý z nich bude mať vlastný názov. Vašou úlohou bude spraviť túto stránku, aby sa dala prehľadne prezerať na akejkoľvek veľkosti obrazovky. Môžete sa inšpirovať videom. Vytvorte stránku na ktorej budete mať 2 karty, každá karta bude mať aspoň jeden obrázok a pod obrázkom text. Ako ďalšie vytvoríte 3 články a každý z nich bude mať vlastný názov. Vašou úlohou bude spraviť túto stránku, aby sa dala prehľadne prezerať na akejkoľvek veľkosti obrazovky. Môžete sa inšpirovať videom.', '../priklady/css/2.1 Responzivita/pr1.html', '../priklady/css/2.1 Responzivita/pr1.css', '', '../priklady/css/2.1 Responzivita/pr1.mp4', ''),
(3, '3 Média', '3.1 Média', 'Vytvorte a pekne nadizajnujte multimediálnu knižnicu, kde budú fotky, videá, audio. Môžete sa  inšpirovať obrázkom.', '../priklady/css/3.1 Média/pr1.html', '../priklady/css/3.1 Média/pr1.css', '../priklady/css/3.1 Média/css-media-pr1.png', '', ''),
(4, '4 Formuláre', '4.1 Formuláre', 'Vytvorte jednoduchý formulár, ktorý pošle údaje zadané používateľom v adresnom riadku prehliadača. Formulár musí byť responzívny a moderne nadizajnovaný. Môžete sa inšpirovať obrázkom.', '../priklady/css/4.1 Formuláre/pr1.html', '../priklady/css/4.1 Formuláre/pr1.css', '../priklady/css/4.1 Formuláre/css-formulare-pr1.png', '', ''),
(5, '5 Tabuľky', '5.1 Tabuľky', 'Vytvorte responzívnu tabuľku aspoň s tromi stĺpcami a štyrmi riadkami. Bonusová úloha: Keď bude tabuľka zobrazená na malej obrazovke, skryte posledný stĺpec. Môžete sa inšpirovať obrázkom.', '../priklady/css/5.1 Tabuľky/pr1.html', '../priklady/css/5.1 Tabuľky/pr1.css', '../priklady/css/5.1 Tabuľky/css-tabulky-pr1.png', '', ''),
(6, '6 Flexbox', '6.1 Flexbox', 'Vytvorte stránku, kde využijete flexbox a zakomponujete obrázok, ktorý je špecifikovaný v css súbore a zistite aké to má výhody a nevýhody. Môžete sa inšpirovať obrázkom.', '../priklady/css/6.1 Flexbox/pr1.html', '../priklady/css/6.1 Flexbox/pr1.css', '../priklady/css/6.1 Flexbox/css-flexbox-pr1.png', '', ''),
...
(7, '6 Navigácia', '6.1 Navigácia', 'Vytvorte dlhšiu webstránku, po ktorej budete môcť skákať kliknutím na navigačný link.<p><strong>Výsledná stránka by mala vyzerať približne takto:</strong>', '../priklady/html/6.1 Navigácia/navigacia-pr1.html', '../priklady/html/6.1 Navigácia/navigacia-pr1.png', '', '');
...
(11, '10 Iné', '10.2 Hodiny', 'Pokúste sa vytvoriť hodiny so sekundami. Viď. video.', '../priklady/js/10.2 Hodiny/pr1.html', '../priklady/js/10.2 Hodiny/pr1.css', '../priklady/js/10.2 Hodiny/pr1.js', '', '', '', '', '../priklady/js/10.2 Hodiny/pr1.mp4', '', '1'),
