...
--
-- Hostiteľ: db
-- Čas generovania: Pi 15.Mar 2024, 07:33
...
(1, '1 Texty', '1.1 Texty', 'Vytvorte jednoduchú webovú stránku so samostatným css súborom, <strong>kde zmeníte veľkosť fontov, farbu textu</strong> podľa vlastného výberu s nasledujúcimi časťami:<br>\r\n<br>\r\n<strong>• hlavička (header)</strong> s názvom webovej stránky a navigačným menu,<br>\r\n<strong>• hlavný obsah (main)</strong> obsahujúci článok, 3 obrázky a vložené video z YouTube,<br>\r\n<strong>• päta (footer)</strong> s copyright informáciami.<br><br>\r\nMôžete sa inšpirovať obrázkom.', '../priklady/css/1.1 Texty/pr1.html', '../priklady/css/1.1 Texty/pr1.css', '../priklady/css/1.1 Texty/css-texty-pr1.png', '', ''),
(2, '2 Responzivita', '2.1 Karty a text', 'Vytvorte stránku, na ktorej budete mať dve karty. Každá karta bude mať aspoň jeden obrázok a pod obrázkom text. Ďalej vytvoríte tri články a každý z nich bude mať vlastný názov.\r\n<br>\r\n<br>Vašou úlohou bude vytvoriť túto stránku tak, aby sa dala prehľadne prezerať na akejkoľvek veľkosti obrazovky. Môžete sa inšpirovať videom.', '../priklady/css/2.1 Karty a text/pr1.html', '../priklady/css/2.1 Karty a text/pr1.css', '', '../priklady/css/2.1 Karty a text/pr1.mp4', ''),
(3, '3 Média', '3.1 Multimediálna knižnica', 'Vytvorte a graficky nadizajnujte webstránku, ktorá bude slúžiť ako multimediálna knižnica. Táto knižnica by mala obsahovať: fotky (minimálne šesť), videá (aspoň dve), audio nahrávku. Môžete sa  inšpirovať obrázkom.', '../priklady/css/3.1 Multimediálna knižnica/pr1.html', '../priklady/css/3.1 Multimediálna knižnica/pr1.css', '../priklady/css/3.1 Multimediálna knižnica/css-media-pr1.png', '', ''),
(4, '4 Formuláre', '4.1 Prihlásenie', 'Vytvorte jednoduchý prihlasovací formulár, ktorý pošle údaje zadané používateľom\r\nv adresnom riadku prehliadača. Formulár musí byť responzívny a moderne nadizajnovaný. Môžete sa inšpirovať obrázkom.', '../priklady/css/4.1 Prihlásenie/pr1.html', '../priklady/css/4.1 Prihlásenie/pr1.css', '../priklady/css/4.1 Prihlásenie/css-formulare-pr1.png', '', ''),
(5, '5 Tabuľky', '5.1 Známky', 'Vytvorte responzívnu tabuľku s aspoň štyrmi stĺpcami a štyrmi riadkami. Taktiež nezabudnite tabuľku vyplniť vašimi hodnotami.<br>\r\n<br>\r\n<strong>Bonusová úloha:</strong>\r\n<br>\r\nKeď bude tabuľka zobrazená na malej obrazovke, schovajte posledný stĺpec.', '../priklady/css/5.1 Známky/pr1.html', '../priklady/css/5.1 Známky/pr1.css', '../priklady/css/5.1 Známky/css-tabulky-pr1.png', '', ''),
...
(8, '8 Navigácia', '8.1 Header Menu', 'Vytvorte dve webstránky na ktoré sa bude môcť používateľ prepínať pomocou navigačného menu a podľa toho, ktorá stránka <strong>je aktívna, vizuálne zmeňte navigačnú linku</strong> na menu, ako je v zadaní, aby používateľ vedel, kde sa práve nachádza. Môžete sa inšpirovať gifom.', '../priklady/css/8.1 Header Menu/pr1-pg1.html', '../priklady/css/8.1 Header Menu/pr1.css', '../priklady/css/8.1 Header Menu/css-menu-pr1.gif', '', ''),
...
(12, '6 Flexbox', '6.2 Karty', 'Vytvorte responzívnu webstránku s kartami, kde využijete gradientné pozadie kariet. Karty musia obsahovať obrázok, text ku karte a tlačidlo. Karty zobrazujte pomocou flexboxu\r\na tlačidlá nemusia robiť žiadnu funkciu navyše.', '../priklady/css/6.2 Karty/karty.html', '../priklady/css/6.2 Karty/karty.css', '', '../priklady/css/6.2 Karty/video.mp4', ''),
...
(15, '8 Navigácia', '8.3 Bottom Menu', 'Vytvorte webstránku, kde sa budete môcť navigovať pomocou menej tradičného\r\nvo webovom dizajne navigačného menu nazývaným po anglicky Bottom Navigation Menu (je to navigačné menu, ako býva napríklad na mobilných aplikáciách v spodnej časti obrazovky).', '../priklady/css/8.3 Bottom Menu/bottom-navigation.html', '../priklady/css/8.3 Bottom Menu/bottom.css', '../priklady/css/8.3 Bottom Menu/obr.png', '', ''),
(16, '8 Navigácia', '8.4 Scrollbar', 'Pri tvorbe webstránok sa spravidla väčšinou zabúda na zakomponovanie vlastného dizajnu pre scrollbar. Táto pomôcka môže používateľovi spríjemniť návštevu vašej webovej stránky vďaka konzistentnému dizajnu. Pomocou CSS3 navrhnite a aplikujte vlastný dizajn scrollbaru.', '../priklady/css/8.4 Scrollbar/vlastny-scrollbar.html', '../priklady/css/8.4 Scrollbar/vlastny-scrollbar.css', '', '../priklady/css/8.4 Scrollbar/Scrollbar.mp4', ''),
...
(20, '4 Formuláre', '4.2 Žiaci', 'Pomocou CSS3 a HTML5 vytvorte webstránku, na ktorej bude môcť používateľ nahrať obrázok, dve textové polia, jedno e-mailové pole a jedno veľké textové pole. Tlačidlo na nahrávanie obrázku musí mať váš vlastný dizajn. Viď obrázok.', '../priklady/css/4.2 Žiaci/ziaci.html', '../priklady/css/4.2 Žiaci/ziaci.css', '../priklady/css/4.2 Žiaci/obrazok.png', '', ''),
...
(22, '10 Transformácie', '10.2 Štvorec', 'Vytvorte transformáciu, ktorá otočí o niekoľko stupňov vami vytvorený geometrický tvar štvorca pomocou CSS3. Keď naň používateľ prejde kurzorom, tak by sa mal otočiť okolo vlastnej osi o niekoľko stupňov a vrátiť sa do pôvodného stavu po odídení kurzora.', '../priklady/css/10.2 Štvorec/štvorec.html', '../priklady/css/10.2 Štvorec/štvorec.css', '', '../priklady/css/10.2 Štvorec/video.mp4', '');
...
(1, '1 Texty', '1.1 Texty', 'Podľa obrázkovej predlohy vytvorte jednoduchú webovú stránku, ktorá bude obsahovať:<br>\r\n<br>\r\n● aspoň tri nadpisy,<br>\r\n● jeden zoznam s aspoň 4-mi elementami,<br>\r\n● jeden odkaz, ktorý po kliknutí presmeruje používateľa na inú webstránku.', '../priklady/html/1.1 Texty/text-pr1.html', '../priklady/html/1.1 Texty/text-pr1.png', '', ''),
(2, '1 Texty', '1.2 Texty', 'Vytvorte jednoduchú webstránku, ktorá bude obsahovať:<br>\r\n<br>\r\n● minimálne šesť nadpisov a <strong>každý iný,</strong><br>\r\n● aspoň dva zoznamy,<br>\r\n● jeden odkaz na inú webovú stránku,<br>\r\n● jeden vložený text v block quotes,<br>\r\n● text, ktorý je v elemente, ktorý zachováva medzery,<br>\r\n● zvýraznený text,<br>\r\n● jednu breaking line.', '../priklady/html/1.2 Texty/text-pr2.html', '../priklady/html/1.2 Texty/text-pr2.png', '', ''),
(3, '2 Média', '2.1 Obrázky', 'Vytvorte nasledovnú webstránku, ktorá bude obsahovať:<br>\r\n<br>\r\n● dva obrázky,<br>\r\n● jedno video importované z YouTube,<br>\r\n● jednu audio stopu/nahrávku, ktorá je uložená v priečinku s vašou stránkou.', '../priklady/html/2.1 Obrázky/media-pr1.html', '../priklady/html/2.1 Obrázky/media-pr1.png', '', ''),
...
(6, '5 Meta údaje', '5.1 Popis', 'Peter si založil internetový obchod, na ktorom predáva tlačiarne a nepáči sa mu, ako vyzerajú výsledky na internetových vyhľadávačoch. Vyhľadávače mu ukazujú náhodný text z jeho webstránky. Vytvorte webovú stránku, ktorá obsahuje aspoň tri produkty\r\ns cenami, niečo o Petrovom obchode a pridajte mu na stránku meta údaje, aby si ho mohli zákazníci ľahšie nájsť.', '../priklady/html/5.1 Popis/meta-pr1.html', '../priklady/html/5.1 Popis/meta-pr1.png', '', ''),
(7, '6 Navigácia', '6.1 Anchor Links', 'Vytvorte dlhšiu webstránku, po ktorej bude môcť používateľ posúvať sa kliknutím myši na navigačný link pomocou tzv. Anchor Links. Vytvorte aspoň päť navigačných linkov ako\r\nv zadaní.', '../priklady/html/6.1 Anchor Links/navigacia-pr1.html', '../priklady/html/6.1 Anchor Links/navigacia-pr1.png', '', ''),
(8, '6 Navigácia', '6.2 Back To Top', 'Vytvorte webstránku, na ktorej budete môcť pomocou linku späť na začiatok poslať používateľa na začiatok stránky, keď sa dostane na koniec stránky, aby nemusel manuálne posúvať na začiatok stránky.', '../priklady/html/6.2 Back To Top/top.html', '', '../priklady/html/6.2 Back To Top/Moja dlhá stránka.mp4', ''),
...
(10, '3 Formuláre', '3.2 POST', 'Vytvorte formulár, pomocou ktorého môže používateľ kontaktovať správcu webstránky. Formulár musí poslať všetky údaje pomocou funkcie <strong>POST.</strong> Následne by sa mala ukázať chyba 405 (Not Allowed), ak nemáte nakonfigurovaný webový server, aby posielal alebo prijímal POST požiadavky. V opačnom prípade by nemalo ukázať chybu a vyčistí formulár.', '../priklady/html/3.2 POST/post.html', '', '../priklady/html/3.2 POST/Kontaktujte nás.mp4', ''),
(11, '5 Meta údaje', '5.2 Kľúčové Slová', 'Petrov obchod si už začínajú pomaly všímať zákazníci. Ale ešte to nie je ono. Pridajte mu na stránku kľúčové slová, aby sa ukázala jeho stránka vo vyhľadávačoch, keď zákazníci hľadajú napríklad tovar a produkty na internete iba pomocou slov.', '../priklady/html/5.2 Kľúčové Slová/keywords.html', '../priklady/html/5.2 Kľúčové Slová/obr.png', '', ''),
(12, '2 Média', '2.3 Webstránky na stránke', 'Pomocou HTML5 vytvorte webstránku, ktorá bude zobrazovať aspoň tri webstránky ako môžete vidieť na videu v zadaní. Nezabudnite, že niektoré stránky ako google.sk majú ochranu voči vkladaniu ich webstránok na iné stránky.', '../priklady/html/2.3 Webstránky na stránke/stránky.html', '', '../priklady/html/2.3 Webstránky na stránke/video.mp4', ''),
(13, '7 Dáta', '7.1 Dátové Listy', 'Vytvorte webovú stránku na ktorej si bude môcť používateľ vybrať druh svojho prehliadača, čas (tento čas by mal mať nadefinované minimálne tri manuálne časy\r\na možnosť iné, aby si mohol používateľ vybrať vlastný čas, ktorý nie je v ponuke), posuvník s nadefinovanými 4-mi hodnotami a možnosť si vybrať farbu (nadefinujte aspoň štyri farby a pridajte možnosť iné, aby si používateľ mohol vybrať aj inú farbu zo všetkých možností).', '../priklady/html/7.1 Dátové Listy/dtlists.html', '', '../priklady/html/7.1 Dátové Listy/video.mp4', ''),
...
(15, '2 Média', '2.4 PDF', 'Vytvorte webstránku, ktorá bude zobrazovať vami vybraný PDF súbor, uložený v priečinku s vašou webstránkou, ako je viditeľné na videu v zadaní.', '../priklady/html/2.4 PDF/pdf-na-stranke.html', '', '../priklady/html/2.4 PDF/video.mp4', ''),
...
(17, '2 Média', '2.2 Stiahnutie', 'Vytvorte webstránku na ktorej budete mať stiahnuteľný ľubovoľný súbor, ktorý <strong>na kliknutie textu tento súbor stiahne (nesmie ho otvoriť v prehliadači)</strong> ako je vidno na videu v zadaní.', '../priklady/html/2.2 Stiahnutie/stiahni.html', '', '../priklady/html/2.2 Stiahnutie/video.mp4', ''),
...
(25, '10 Sémantika', '10.4 Spojenie', 'V predchádzajúcich príkladoch ste vytvorili tri základné stránky bez použitia základných tagov/elementov. Teraz je vašou úlohou vytvoriť webstránku, ktorá tieto stránky zobrazí na sebe ako <strong>jednu</strong> stránku.<br>\r\n<br>\r\n<strong>Tip:</strong> Už ste sa stretli s týmto elementom s príkladom v kategórii média.', '../priklady/html/10.4 Spojenie/spojenie.html', '../priklady/html/10.4 Spojenie/obr-spojenie.png', '', ''),
...
(27, '9 Interaktivita', '9.2 Prístupnosť', 'Prístupnosť webovej stránky je veľmi dôležitá vec, keď vieme, že webstránku budú navštevovať rôzny používatelia. Nemali by sme zabúdať ani na zdravotne znevýhodnených používateľov vašej webovej stránky.\r\nVytvorte webovú stránku, ktorá bude obsahovať čo najviac dostupného obsahu pre nevidiacich. Na otestovanie môžete použiť program NV Access, ktorý je prístupný zdarma.<br>\r\n<br>\r\n<a href=\"https://www.nvaccess.org/download/\" class=\"btn btn-primary\" role=\"button\" target=\"_blank\">NV Access</a>\r\n', '../priklady/html/9.2 Prístupnosť/accessibilty.html', '', '../priklady/html/9.2 Prístupnosť/video.mp4', '');
...
(6, '6 Vyskakovacie okná', '6.1 Povoliť Cookies', 'Vytvorte vyskakovacie okno, ktoré si bude pýtať od používateľa súhlas, aby prijal cookies. Toto následne uložte do lokálneho úložiska, aby sa ho webstránka neskôr nepýtala o opätovné prijatie. Môžete sa inšpirovať videom v zadaní.', '../priklady/js/6.1 Povoliť Cookies/pr1.html', '../priklady/js/6.1 Povoliť Cookies/pr1.css', '../priklady/js/6.1 Povoliť Cookies/pr1.js', '', '', '', '', '../priklady/js/6.1 Povoliť Cookies/pr1.mp4', '', '1'),
(7, '7 Drag and Drop', '7.1 Kôš', 'Vytvorte stránku, na ktorej budete mať obrázok koša a budete môcť do neho pomocou funkcie drag and drop pretiahnuť elementy, ktoré potom zmiznú. Vždy, keď sa vloží niečo do koša, napíše sa náhodné slovo, ktoré zmizne po pár sekundách. Môžete sa inšpirovať videom v zadaní.', '../priklady/js/7.1 Kôš/pr1.html', '../priklady/js/7.1 Kôš/pr1.css', '../priklady/js/7.1 Kôš/pr1.js', '', '', '', '', '../priklady/js/7.1 Kôš/pr1.mp4', '', '1'),
(8, '8 Tabuľky', '8.1 Správa dát v tabuľke', 'Vytvorte webstránku s tabuľkou, do ktorej bude môcť používateľ pridávať, upravovať\r\na mazať údaje. Pokúste sa navrhnúť vlastný dizajn stránky a jej rozloženie, ako je vidieť na videu v zadaní.', '../priklady/js/8.1 Správa dát v tabuľke/pr1.html', '../priklady/js/8.1 Správa dát v tabuľke/pr1.css', '../priklady/js/8.1 Správa dát v tabuľke/pr1.js', '', '', '', '', '../priklady/js/8.1 Správa dát v tabuľke/pr1.mp4', '', '1'),
(9, '9 Vyhľadávanie', '9.1 Vyhľadávanie na aktuálnej stránke', 'Každý poznáme vyhľadávacie okno na internetových obchodoch. Toto okno väčšinou čaká na potvrdenie vstupu stlačením tlačidla enter alebo tlačidla hľadať. Vytvorte webstránku, kde bude môcť používateľ hľadať pomocou vyhľadávacieho okna produkty vášho internetového obchodu, ale miesto toho, aby používateľ potvrdil vstup, hneď ukazujte\r\nv reálnom čase výsledky na aktuálnej stránke. Môžete sa inšpirovať videom v zadaní.', '../priklady/js/9.1 Vyhľadávanie na aktuálnej stránke/pr1.html', '../priklady/js/9.1 Vyhľadávanie na aktuálnej stránke/pr1.css', '../priklady/js/9.1 Vyhľadávanie na aktuálnej stránke/pr1.js', '', '', '', '', '../priklady/js/9.1 Vyhľadávanie na aktuálnej stránke/pr1.mp4', '', '1'),
...
(13, '2 AJAX', '2.1 Čas a náhodný text', 'Pomocou priloženej knižnice vytvorte webstránku, na ktorej sa bude zobrazovať <strong>aktuálny čas, náhodná veta</strong> podľa vášho výberu <strong>(viet musí byť aspoň päť)</strong> a táto veta sa bude meniť každých <strong>desať sekúnd.</strong> Následne vytvorte <strong>odpočítavanie,</strong> ktoré bude ukazovať v <strong>reálnom čase,</strong> kedy sa bude meniť táto <strong>náhodná veta.</strong> Môžete sa inšpirovať videom.', '../priklady/js/2.1 Čas a náhodný text/cas-text.html', '../priklady/js/2.1 Čas a náhodný text/cas-text.css', '../priklady/js/2.1 Čas a náhodný text/script.js', '', '../priklady/js/2.1 Čas a náhodný text/jquery-3.7.1.js', 'https://api.jquery.com/', '', '../priklady/js/2.1 Čas a náhodný text/Video.mp4', '', '1'),
(14, '4 Navigácia', '4.2 Single Page', 'Pomocou vašich znalostí vytvorte webstránku, ktorá bude mať iba jednu HTML5 stránku, ale bude obsahovať aspoň tri stránky. Tj. webstránka nesmie presmerovať používateľa na inú stránku. Viď video.', '../priklady/js/4.2 Single Page/index.html', '../priklady/js/4.2 Single Page/style.css', '../priklady/js/4.2 Single Page/script.js', '', '', '', '', '../priklady/js/4.2 Single Page/video.mp4', '', '1'),
(15, '2 AJAX', '2.2 Počasie (API)', 'Vytvorte webstránku o počasí, ktorá bude každých 60 sekúnd obnovovať údaje o počasí z priloženej dokumentácie.<br>\r\n<br>\r\nAko prvé sa budete musieť zaregistrovať a získať <strong>zadarmo</strong> API kľúč a potom si zistiť identifikačné číslo mesta, o ktorom chcete zistiť aktuálne informácie. Toto identifikačné číslo mesta získate taktiež pomocou prečítaní dokumentácie alebo z url, keď si otvoríte mesto na ich stránke.\r\n', '../priklady/js/2.2 Počasie (API)/počasie.html', '../priklady/js/2.2 Počasie (API)/počasie.css', '../priklady/js/2.2 Počasie (API)/script.js', '', '../priklady/js/2.2 Počasie (API)/jquery-3.7.1.js', 'https://openweathermap.org/api', '', '../priklady/js/2.2 Počasie (API)/video.mp4', '', '1'),
...
(17, '5 Správa CSS', '5.2 Zmena farby pozadia', 'Vytvorte webovú stránku, ktorá bude na vstup používateľa meniť farbu pozadia, ako je to viditeľné na videu v zadaní.<br><br>\r\n<strong>Bonusová úloha:</strong> Majte na stránke text a meňte jeho farbu tak, aby bol vždy čitateľný, ako na videu v zadaní.', '../priklady/js/5.2 Zmena farby pozadia/color-picker.html', '../priklady/js/5.2 Zmena farby pozadia/style.css', '../priklady/js/5.2 Zmena farby pozadia/color-picker.js', '', '', '', '', '../priklady/js/5.2 Zmena farby pozadia/video.mp4', '', '1'),
(18, '6 Vyskakovacie okná', '6.2 Poistka', 'Vytvorte vyskakovacie okno u obchodníka s autami. Toto okno by sa malo ukazovať používateľovi webstránky opakovanie v loope. Môžete sa inšpirovať videom v zadaní.', '../priklady/js/6.2 Poistka/poistka.html', '../priklady/js/6.2 Poistka/style.css', '../priklady/js/6.2 Poistka/script.js', '', '', '', '', '../priklady/js/6.2 Poistka/video.mp4', '', '1'),
(19, '7 Drag and Drop', '7.2 Umenie', 'Vytvorte webstránku, ktorá bude náhodne hodnotiť používateľom nahraté obrázky, ako je vidieť na obrázku v zadaní.', '../priklady/js/7.2 Umenie/umenie.html', '../priklady/js/7.2 Umenie/style.css', '../priklady/js/7.2 Umenie/script.js', '', '', '', '../priklady/js/7.2 Umenie/zadanie.gif', '', '', '1'),
(20, '8 Tabuľky', '8.2 Tabuľka z JSON súboru', 'Niekedy je potrebné rýchlo načítať údaje zo súboru a zobraziť ich v tabuľke. V tomto prípade máme priložený v zadaní JSON súbor, ktorý si je potrebné pozorne pozrieť\r\na podľa tohto priloženého súboru vytvorte webstránku, ktorá automaticky po nahratí používateľom vytvorí z tohto súboru plného údajov tabuľku, ako je na videu v zadaní.', '../priklady/js/8.2 Tabuľka z JSON súboru/tabulka.html', '../priklady/js/8.2 Tabuľka z JSON súboru/style.css', '../priklady/js/8.2 Tabuľka z JSON súboru/script.js', '../priklady/js/8.2 Tabuľka z JSON súboru/súbor.json', '', '', '', '../priklady/js/8.2 Tabuľka z JSON súboru/video.mp4', '', '1'),
(21, '9 Vyhľadávanie', '9.2 Hľadanie Gifov', 'Pomocou <strong>GIPHY API</strong> (registrácia a API kľúč sú zadarmo) vytvorte webstránku, na ktorej môže používateľ hľadať rôzne gify. V zadaní máte priloženú dokumentáciu k tejto vzdialenej API. Je tam tiež vysvetlenie, ako dostať API kľúč, aby ste mohli posielať požiadavky na vzdialený server. Môžete sa inšpirovať videom zo zadania.', '../priklady/js/9.2 Hľadanie Gifov/gify.html', '../priklady/js/9.2 Hľadanie Gifov/style.css', '../priklady/js/9.2 Hľadanie Gifov/script.js', '', '', 'https://developers.giphy.com/docs/api#quick-start-guide', '', '../priklady/js/9.2 Hľadanie Gifov/video.mp4', '', '1');
