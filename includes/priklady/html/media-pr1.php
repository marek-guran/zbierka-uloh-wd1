    ...
    <div class="row">
        <div class="col-md-6">
            <div class="priklad card-text">
                ...
                <p>
                    Vašou úlohou je vytvoriť webstránku s multimediálnymi prvkami. Dodržte nasledujúce inštrukcie na
                    zahrnutie
                    ...
                    Vytvorte alebo nájdite malý obrázok, ktorý bude reprezentovať vašu webovú stránku. Tento obrázok
                    bude použitý
                    ...
                    Pridajte audio súbor (napríklad .mp3 alebo .ogg) do vášho projektu a odkážte sa naň vo vašom HTML
                    kóde.<br>
                    Poskytnite ovládanie pre prehrávanie a pozastavenie zvuku. A ak zariadenie nepodporuje túto
                    funkcionalitu,
