    ...
    <div class="row">
        <div class="col-md-6">
            <div class="priklad card-text">
                <h2>Tabuľky</h2>
                <p>Vytvorte tabuľku, do ktorej budete môcť pridávať, upravovať a mazať údaje. Viď. video.
                <p>
            </div>
        </div>
        <div class="col-md-6">
            <div class="video-container">
                <video src="../video/priklady/js/tabulky/pr1.mp4" alt="Video príkladu" controls></video>
            </div>
        </div>
    </div>
</div>
...
<div class="code-wrapper container code-pill-container">
    ...
    <a href="../priklady/js/tabulky/pr1.html" target="_blank">
...
$filePath = $documentRoot . '/priklady/js/tabulky/pr1.html';
...
<?php
$documentRoot = $_SERVER['DOCUMENT_ROOT'];
$cssFilePath = $documentRoot . '/priklady/js/tabulky/pr1.css';
...
<?php
$documentRoot = $_SERVER['DOCUMENT_ROOT'];
$jsFilePath = $documentRoot . '/priklady/js/tabulky/pr1.js';
