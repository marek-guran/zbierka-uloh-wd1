    ...
    <div class="row">
        <div class="col-md-6">
            <div class="priklad card-text">
                <h2>Drag And Drop</h2>
                <p>Vytvorte stránku, na ktorej budete mať obrázok koša a budete môcť do neho pomocou funkcie drag and
                    drop pretiahnuť elementy, ktoré potom zmiznú. Vždy, keď sa vloží niečo do koša, tak nech napíše
                    niake slovo, ktoré zmizne po pár sekundách. Viď. video.
                <p>
            </div>
        </div>
        <div class="col-md-6">
            <div class="video-container">
                <video src="../video/priklady/js/drag-and-drop/pr1.mp4" alt="Video príkladu" controls></video>
            </div>
        </div>
    </div>
</div>
...
<div class="code-wrapper container code-pill-container">
    ...
    <a href="../priklady/js/drag-and-drop/pr1.html" target="_blank">
...
$filePath = $documentRoot . '/priklady/js/drag-and-drop/pr1.html';
...
<?php
$documentRoot = $_SERVER['DOCUMENT_ROOT'];
$cssFilePath = $documentRoot . '/priklady/js/drag-and-drop/pr1.css';
...
<?php
$documentRoot = $_SERVER['DOCUMENT_ROOT'];
$jsFilePath = $documentRoot . '/priklady/js/drag-and-drop/pr1.js';
