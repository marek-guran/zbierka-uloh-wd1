    ...
    <div class="row">
        <div class="col-md-6">
            <div class="priklad card-text">
                <h2>Vyhľadávanie na stránke</h2>
                <p>Vytvorte stránku, kde budete môcť hľadať pomocou vyhľadávacieho okna produkty e-shopu. Viď. video.
                <p>
            </div>
        </div>
        <div class="col-md-6">
            <div class="video-container">
                <video src="../video/priklady/js/vyhladavanie/pr1.mp4" alt="Video príkladu" controls></video>
            </div>
        </div>
    </div>
</div>
...
<div class="code-wrapper container code-pill-container">
    ...
    <a href="../priklady/js/vyhladavanie/pr1.html" target="_blank">
...
$filePath = $documentRoot . '/priklady/js/vyhladavanie/pr1.html';
...
<?php
$documentRoot = $_SERVER['DOCUMENT_ROOT'];
$cssFilePath = $documentRoot . '/priklady/js/vyhladavanie/pr1.css';
...
<?php
$documentRoot = $_SERVER['DOCUMENT_ROOT'];
$jsFilePath = $documentRoot . '/priklady/js/vyhladavanie/pr1.js';
