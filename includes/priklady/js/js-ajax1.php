    ...
    <div class="row">
        <div class="col-md-6">
            <div class="priklad card-text">
                <h2>AJAX</h2>
                <p>Pomocou priloženého súboru JSON vytvorte stránku, ktorá zobrazí jeho obsah na kliknutie tlačidla.
                    Viď. video.
                <p>
                <p><i class="fa-solid fa-download"></i> <strong>Na Stiahnutie</strong></p>
                <a href="../includes/priklady/js/download/ajax/pr1.json" download class="btn btn-primary"><i
                        class="fa-regular fa-file-lines"></i> JSON</a>
            </div>
        </div>
        <div class="col-md-6">
            <div class="video-container">
                <video src="../video/priklady/js/ajax/pr1.mp4" alt="Video príkladu" controls></video>
            </div>
        </div>
    </div>
</div>
...
<div class="code-wrapper container code-pill-container">
    ...
    <a href="../priklady/js/ajax/pr1.html" target="_blank">
...
$filePath = $documentRoot . '/priklady/js/ajax/pr1.html';
...
<?php
$documentRoot = $_SERVER['DOCUMENT_ROOT'];
$cssFilePath = $documentRoot . '/priklady/js/ajax/pr1.css';
...
<?php
$documentRoot = $_SERVER['DOCUMENT_ROOT'];
$jsFilePath = $documentRoot . '/priklady/js/ajax/pr1.js';
