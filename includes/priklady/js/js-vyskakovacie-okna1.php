    ...
    <div class="row">
        <div class="col-md-6">
            <div class="priklad card-text">
                <h2>Vyskakovacie okná</h2>
                <p>Vytvorte vyskakovacie okno, ktoré si bude pýtať od používateľa aby prijal Cookies. Toto následne
                    uložte do lokálneho úložiska aby sa ho stránka nabudúce nepýtala jeho prijatie. Viď. video.
                <p>
            </div>
        </div>
        <div class="col-md-6">
            <div class="video-container">
                <video src="../video/priklady/js/vyskakovacie-okna/pr1.mp4" alt="Video príkladu" controls></video>
            </div>
        </div>
    </div>
</div>
...
<div class="code-wrapper container code-pill-container">
    ...
    <a href="../priklady/js/vyskakovacie-okna/pr1.html" target="_blank">
...
$filePath = $documentRoot . '/priklady/js/vyskakovacie-okna/pr1.html';
...
<?php
$documentRoot = $_SERVER['DOCUMENT_ROOT'];
$cssFilePath = $documentRoot . '/priklady/js/vyskakovacie-okna/pr1.css';
...
<?php
$documentRoot = $_SERVER['DOCUMENT_ROOT'];
$jsFilePath = $documentRoot . '/priklady/js/vyskakovacie-okna/pr1.js';
