    ...
    <div class="row">
        <div class="col-md-6">
            <div class="priklad card-text">
                <h2>Média</h2>
                <p>Vytvorte a pekne nadizajnujte multimediálnu knižnicu, kde budú fotky, videá, audio. Môžete sa
                    inšpirovať obrázkom.
                <p>
            </div>
        </div>
        <div class="col-md-6">
            <div class="img-container">
                <a href="../img/priklady/css/media/css-media-pr1.png" target="_blank">
                    <img src="../img/priklady/css/media/css-media-pr1.png" alt="Zadanie príkladu" class="img-zadania">
...
<div class="code-wrapper container code-pill-container">
    ...
    <a href="../priklady/css/media/pr1.html" target="_blank">
...
$filePath = $documentRoot . '/priklady/css/media/pr1.html';
...
<?php
$documentRoot = $_SERVER['DOCUMENT_ROOT'];
$cssFilePath = $documentRoot . '/priklady/css/media/pr1.css';
