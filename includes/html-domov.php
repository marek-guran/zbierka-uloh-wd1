...
if ($result->num_rows > 0) {
    ...
    foreach ($rows as $row) {
        ...
        echo '<div class="col-md-12"><div class="card-text text-center mb-2 ' . $stromClass . '" onclick="event.preventDefault(); window.location.href = \'html_page_priklad.php?pr=' . $nazov . '\';"><div class="card-body"><p class="card-title">' . $nazov . '</p></div></div></div>';
        $counter++;
    }
    echo '</div></div></div>';
} else {
